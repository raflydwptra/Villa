                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-indoor">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('Gp/assets/img/RuangTamu.jpg')}}" class="img-fluid" alt="" width="416" height="225">
                            <div class="portfolio-info">
                                <h4>Ruang Tamu</h4>
                                <div class="portfolio-links">
                                    <a href="{{ asset('Gp/assets/img/RuangTamu.jpg')}}" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Ruang Tamu"><i class="bx bx-fullscreen"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-2 portfolio-item filter-indoor">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('Gp/assets/img/portfolio/Dapur.jpg')}}" class="img-fluid" alt="" width="416" height="225">
                            <div class="portfolio-info">
                                <h4>Dapur</h4>
                                <div class="portfolio-links">
                                    <a href="{{ asset('Gp/assets/img/portfolio/Dapur.jpg')}}" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Dapur"><i class="bx bx-fullscreen"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-indoor">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('Gp/assets/img/bakaran.jpg')}}" class="img-fluid" alt="" width="416" height="225">
                            <div class="portfolio-info">
                                <h4>Ruang Kumpul</h4>
                                <div class="portfolio-links">
                                    <a href="{{ asset('Gp/assets/img/Bakaran.jpg')}}" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Ruang Kumpul"><i class="bx bx-fullscreen"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-outdoor">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('Gp/assets/img/halamanbelakang.jpg')}}" class="img-fluid" alt="" width="416" height="225">
                            <div class="portfolio-info">
                                <h4>Halaman Belakang</h4>
                                <div class="portfolio-links">
                                    <a href="{{ asset('Gp/assets/img/halamanbelakang.jpg')}}" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Halaman Belakang"><i class="bx bx-fullscreen"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-indoor">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('Gp/assets/img/kamar.jpg')}}" class="img-fluid" alt="" width="416" height="225">
                            <div class="portfolio-info">
                                <h4>Kamar Tidur</h4>
                                <div class="portfolio-links">
                                    <a href="{{ asset('Gp/assets/img/kamar.jpg')}}" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Kamar Tidur"><i class="bx bx-fullscreen"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-outdoor">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('Gp/assets/img/balcony.jpg')}}" class="img-fluid" alt="" width="416" height="225">
                            <div class="portfolio-info">
                                <h4>Balcony</h4>
                                <div class="portfolio-links">
                                    <a href="{{ asset('Gp/assets/img/balcony.jpg')}}" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Balcony"><i class="bx bx-fullscreen"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-outdoor">
                        <div class="portfolio-wrap">
                            <img src="Gp/assets/img/halaman.jpg" class="img-fluid" alt="" width="416" height="225">
                            <div class="portfolio-info">
                                <h4>Halaman</h4>
                                <div class="portfolio-links">
                                    <a href="{{ asset('Gp/assets/img/halaman.jpg')}}" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Halaman"><i class="bx bx-fullscreen"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-outdoor">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('Gp/assets/img/kolamrenang.jpg')}}" class="img-fluid" alt="" width="416" height="225">
                            <div class="portfolio-info">
                                <h4>Kolam Renang</h4>
                                <div class="portfolio-links">
                                    <a href="{{ asset('Gp/assets/img/kolamrenang.jpg')}}" data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="Kolam Renang"><i class="bx bx-fullscreen"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
